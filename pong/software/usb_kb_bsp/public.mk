...
# setting SOPC_SYSID_BASE_ADDRESS is 0x11d0
SOPC_SYSID_FLAG += --sidp=0x11d0
ELF_PATCH_FLAG  += --sidp 0x11d0

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1682024540
SOPC_SYSID_FLAG += --timestamp=1682024540
ELF_PATCH_FLAG  += --timestamp 1682024540
