...
lappend arg_list "--report-file=csv:sdram_example.csv"
lappend arg_list "--report-file=qip:sdram_example.qip"
lappend arg_list "--output-name=sdram_example"
...
lappend arg_list "--component-param=SYS_INFO_DEVICE_FAMILY=MAX 10"
...
catch { eval [concat [list exec "C:/intelfpga_lite/18.1/quartus//sopc_builder/bin/ip-generate" --component-name=alt_mem_if_ddr2_tg_ed] $arg_list] } temp
puts $temp
